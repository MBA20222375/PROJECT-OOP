...
$cartItems = \Oop\Project\Cart::getCartItemsWithDetails($cart->getItems(), $db);
$total = \Oop\Project\Cart::getCartTotal($cart->getItems(), $db);
?>
<main class="mb-4">
                        ...
                        <div class="cart-item d-flex align-items-center border-bottom pb-3 mb-3">
                          <div class="cart-item-image me-3">
                            <?php if ($item['product']->getImage()): ?>
                              <img src="public/uploads/books/<?php echo htmlspecialchars($item['product']->getImage()); ?>" 
                          ...
                          <div class="cart-item-remove ms-3">
                            <a href="index.php?page=cart&action=remove&product_id=<?php echo $item['product']->getId(); ?>" 
