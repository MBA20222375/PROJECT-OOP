<main>
  ...
  <section class="section-container contact d-md-flex align-items-center mb-3">
    <div class="contact__side w-50">
      ...
      <p>إذا كنت تواجه أي مشكلة أو ترغب في إسترجاع أو إستبدال المنتج لا تتردد أبدأ بالتواصل معنا في أي وقت. كل ماعليك هو
        ملئ النموذج التالي ببيانات صحيحة وسنقوم بمراجعة طلبك في أسرع وقت.</p>
     <form class="contact__form" method="POST" action="index.php?page=contact-store">

  <div class="d-flex gap-3 mb-3">
    <div class="w-50">
      <label for="name">الاسم<span class="required">*</span></label>
      <input class="contact__input" id="name" type="text" name="name" required>
    </div>
    <div class="w-50">
      <label for="phone">رقم الهاتف<span class="required">*</span></label>
      <input class="contact__input" id="phone" type="text" name="phone" required>
    </div>
  </div>

  <div class="mb-3">
    <label for="email">البريد الالكتروني<span class="required">*</span></label>
    <input class="contact__input" id="email" type="text" name="email" required>
  </div>
  ...
  <div>
    ...
    <textarea class="contact__input" id="message" name="message" required></textarea>
  </div>

  <button class="primary-button w-100 rounded-2" type="submit">
    ارسال الطلب
  </button>
