        ...
        <div class="profile__right">
          ...
          <ul class="profile__tabs list-unstyled ps-3">
            ...
            <li class="profile__tab active">
              <a
                class="py-2 px-3 text-black text-decoration-none"
                href="index.php?page=account_details"
                >تفاصيل الحساب</a
              >
            </li>
            <li class="profile__tab">
            ...
            <li class="profile__tab">
              <a class="py-2 px-3 text-black text-decoration-none" href=""
                >تسجيل الخروج</a
              >
            </li>
          </ul>
          ...
          <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
            ...
            <div class="footer__list list-unstyled p-0">
              ...
              <li>
                <a
                  class="footer__link text-decoration-none d-inline-block text-gray py-1"
                  href="index.php?page=privacy_policy"
                  >سياسة الخصوصية</a
                >
              </li>
              <li>
                <a
                  class="footer__link text-decoration-none d-inline-block text-gray py-1"
                  href="index.php?page=refund_policy"
              ...
              <li>
                <a
                  class="footer__link text-decoration-none d-inline-block text-gray py-1"
                  href="index.php?page=track_order"
                  >تتبع طلبك</a
                >
              </li>
            </div>
