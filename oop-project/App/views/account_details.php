  ...
  <section class="section-container profile my-3 my-md-5 py-5 d-md-flex gap-5">
    ...
    <div class="profile__left mt-4 mt-md-0 w-100">
      <div class="profile__tab-content active">
        <form class="profile__form border p-3" action="index.php?page=account-details-control" method="post">
          ...
          <div class="d-flex gap-3 mb-3">
            <div class="w-100">
              ...
              <input type="text" class="form__input" name="first-name" />
            </div>
            <div class="w-100">
              <label class="fw-bold mb-2" for="last-name">
                الاسم الأخير <span class="required">*</span>
              </label>
              <input type="text" class="form__input" name="last-name" />
            </div>
          </div>
        ...
        <form action="index.php?page=account-details-control" method="post">
          ...
          <fieldset>
            ...
            <div class="w-100 mb-3">
              ...
              <input type="text" class="form__input" name="current_password" />
            </div>
            <div class="w-100 mb-3">
              <label class="fw-bold mb-2" for="curr-password">
              ...
              <input type="text" class="form__input" name="new_password" />
            </div>
            <div class="w-100 mb-3">
              <label class="fw-bold mb-2" for="curr-password">
                تأكيد كلمة المرور الجديدة
              </label>
              <input type="text" class="form__input" name="confirm_password" />
            </div>
