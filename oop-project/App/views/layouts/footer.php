      ...
      <div class="section-container row">
        ...
        <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
          ...
          <div class="footer__list list-unstyled p-0">
            ...
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="index.php?page=privacy_policy">سياسة الخصوصية</a></li>
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="index.php?page=refund_policy">سياسة الاستبدال و
                الاسترجاع</a></li>
            <li><a class="footer__link text-decoration-none d-inline-block text-gray py-1" href="index.php?page=track_order">تتبع طلبك</a></li>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 px-md-4 mb-5 mb-lg-0">
          <div class="footer__list-title fw-bolder mb-1">
