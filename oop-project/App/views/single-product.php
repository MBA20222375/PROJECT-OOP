...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="App/assets/css/vendors/splide.min.css">
  ...
  <body>
        ...
        <nav class="nav">
          <div class="section-container w-100 d-flex align-items-center gap-4 h-100">
            ...
            <ul class="nav__links gap-3 list-unstyled d-none d-lg-flex m-0">
              ...
              <li class="nav__link">
                <a class="d-flex align-items-center gap-2" data-bs-toggle="modal" data-bs-target="#account__modal">
                  تسجيل الدخول
                  <i class="fa-regular fa-user"></i>
                </a>
              </li>
    ...
    <script src="App/assets/js/vendors/splide.min.js"></script>
    <script src="App/assets/js/vendors/owl.carousel.min.js"></script>
    <script src="https://unpkg.com/js-image-zoom@0.7.0/js-image-zoom.js" type="application/javascript"></script>
    <script src="App/assets/js/single-product.js"></script>
