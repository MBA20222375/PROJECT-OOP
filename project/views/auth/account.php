  ...
  <div class="page-full pb-5">
    <div class="account account--login mt-5 pt-5">
      ...
      <div class="account__register w-100">
        <form method="POST" action="index.php?page=account-control&action=register" class="mb-5">
          <div class="input-group rounded-1 mb-3">
            <input type="text" class="form-control p-3" name="name" placeholder="الاسم كامل" aria-label="Username"
              aria-describedby="basic-addon1" />
            <span class="input-group-text login__input-icon" id="basic-addon1">
          ...
          <div class="input-group rounded-1 mb-3">
            <input type="email" name="email" class="form-control p-3" placeholder="البريد الالكتروني" aria-label="Email"
              aria-describedby="basic-addon1" />
            <span class="input-group-text login__input-icon" id="basic-addon1">
              <i class="fa-solid fa-envelope"></i>
            </span>
